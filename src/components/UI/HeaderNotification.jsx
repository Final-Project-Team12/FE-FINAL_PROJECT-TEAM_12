  ...
  return (
    <div className="border-b py-2 -mt-2 shadow-[0px_4px_10px_rgba(0,0,0,0.1)]">
      <div className="ml-4 mr-3 sm:ml-[64px] sm:mr-[48px] md:ml-[20px] md:mr-[20px] lg:mr-[50px] lg:ml-[50px] xl:ml-[260px] xl:mr-[212px] mb-5">
        ...
        <div className="md:flex md:flex-col md:mx-3 lg:flex lg:flex-col xl:flex xl:flex-row xl:mx-4 gap-3 items-center">
          <div
            className="xl:w-[750px] h-[50px] rounded-[12px] bg-[#A06ECE] flex items-center cursor-pointer"
            onClick={() => navigate('/')}
          >
